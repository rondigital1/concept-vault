...
import type { InspectorFieldChange, TopicWorkflowDraft } from './agentsInspectorTypes';
...
export function TopicOverridesPanel({
  topicOptions,
  selectedTopicId,
  selectedTopic,
  topicDraft,
            ...
            <div className={`${workspaceInsetSurfaceClassName} p-4`}>
              <fieldset className="space-y-4">
                ...
                <RunModeSelect
                  ...
                  onChange={(value) => onTopicChange('defaultRunMode', value)}
                />
