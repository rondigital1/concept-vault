  ...
  return (
    <div className="relative" ref={menuRef}>
      <button
        ...
        className="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium text-zinc-400 hover:text-white hover:bg-zinc-800 rounded-lg transition-colors"
      >
      ...
      {open && (
        <div className="absolute top-full left-0 mt-1 w-56 bg-zinc-900 border border-zinc-800 rounded-lg shadow-xl z-50 py-1">
          ...
          {collections.map((c) => {
            ...
            return (
              <button
                ...
                disabled={isPending}
                className="w-full flex items-center gap-2 px-3 py-1.5 text-sm text-zinc-300 hover:bg-zinc-800 transition-colors disabled:opacity-50"
              >
                <div
