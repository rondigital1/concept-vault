...
import { cx, getOverlayActionClassName } from './overlaySurfaceClasses';
import type { ConfirmDialogProps, OverlaySurfaceProps } from './overlaySurfaceTypes';
import { useOverlayFocusTrap } from './useOverlayFocusTrap';
import { useOverlayPortal } from './useOverlayPortal';

export { getOverlayActionClassName } from './overlaySurfaceClasses';
...
export function OverlaySurface({
  ...
  const portalNode = useOverlayPortal(kind);
