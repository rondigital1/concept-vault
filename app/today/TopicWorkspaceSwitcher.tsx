    ...
    <>
      ...
      {isOpen ? (
        ...
        >
          ...
          <div className="today-panel today-panel-high today-glass relative w-full max-w-[560px] overflow-hidden rounded-[30px]">
            ...
            <div className="today-scroll max-h-[360px] overflow-y-auto px-3 pb-3">
              {visibleTopics.length > 0 ? (
                ...
                <div className="px-3 py-6 text-sm text-[color:var(--today-muted)]">No topics match that search.</div>
              )}
            </div>
